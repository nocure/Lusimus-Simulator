...
// ww 2018-0815 commented out, MODET is always required and is defined in armdefs.h.
#if 0
...
tdstate ARMul_ThumbDecode(state, pc, tinstr, ainstr)
	ARMul_State *state;ARMword pc;ARMword tinstr;ARMword *ainstr; {
	...
	*ainstr = 0xDEADC0DE;
	...
	case 3: /* ADD/SUB */
		/* Format 2 */
	{
		ARMword subset[4] = { 0xE0900000, /* ADDS Rd,Rs,Rn    */
	...
	case 7: /* SUB */
		/* Format 3 */
	{
		ARMword subset[4] = { 0xE3B00000, /* MOVS Rd,#imm8    */
	...
	case 8: /* Arithmetic and high register transfers */
		...
		if ((tinstr & (1 << 10)) == 0) {
			...
			} subset[16] = { { 0xE0100000, t_norm }, /* ANDS Rd,Rd,Rs     */
	...
	case 11:
		...
		if ((tinstr & (1 << 9)) == 0) {
			/* Format 7 */
			ARMword subset[4] = { 0xE7800000, /* STR  Rd,[Rb,Ro] */
			...
			*ainstr = subset[(tinstr & 0x0C00) >> 10] /* base */
			...
			/* Format 8 */
			ARMword subset[4] = { 0xE18000B0, /* STRH  Rd,[Rb,Ro] */
	...
	case 15: /* LDRB Rd,[Rb,#imm5] */
		/* Format 9 */
	{
		ARMword subset[4] = { 0xE5800000, /* STR  Rd,[Rb,#imm5] */
	...
	case 23:
		if ((tinstr & 0x0F00) == 0x0000) {
			...
			*ainstr = 0xEF000000 | SWI_Breakpoint;
			...
			/* Format 14 */
			ARMword subset[4] = { 0xE92D0000, /* STMDB sp!,{rlist}    */
	...
	case 30: /* BL instruction 1 */
		...
		if (((tinstr & 0xF800) >> 11) != 31) break; /* exit, since not correct instruction */
