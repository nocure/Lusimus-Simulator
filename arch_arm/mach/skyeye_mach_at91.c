...
static ARMword
at91_io_read_byte (void * state, ARMword addr)
{
	fprintf(stderr, "IO erro in %s, addr=0x%x\n", __FUNCTION__,addr);
	return 0;
}
...
ARMword
at91_io_read_halfword (void * state, ARMword addr)
{
	fprintf(stderr, "IO erro in %s\n", __FUNCTION__);
	return 0;
}
...
ARMword
at91_io_read_word (void * state, ARMword addr)
{
	...
	default:
		...
		//fprintf (stderr,
		//       "NumInstr %I64u, io_read_word unknown addr(0x%08x) = 0x%08x\n",
...
void
at91_io_write_byte (void * state, ARMword addr, ARMword data)
{
...
void
at91_io_write_halfword (void * state, ARMword addr, ARMword data)
{
...
void
at91_io_write_word (void * state, ARMword addr, ARMword data)
{
	/*
	...
	default:
		...
		//DBG_PRINT("io_write_word(0x%08x) = 0x%08x\n", addr, data);
		//fprintf (stderr,
		//       "NumInstr %I64u,io_write_word unknown addr(0x%08x) = 0x%08x\n",
		//       state->NumInstrs, addr, data);
		//SKYEYE_OUTREGS (stderr);
		//ARMul_Debug(state, 0, 0);
		break;
