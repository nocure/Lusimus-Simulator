...
ARMword
cs89712_io_read_byte (void * state, ARMword addr)
{
	/*printf("cs89712_io_read_byte error\n"); */
	skyeye_exit (-1);
}

ARMword
cs89712_io_read_halfword (void * state, ARMword addr)
{
	/*printf("cs89712_io_read_halfword error\n"); */
	skyeye_exit (-1);
}

ARMword
cs89712_io_read_word (void * state, ARMword addr)
{
	ARMword data = 0;
...
void
cs89712_io_write_byte (void * state, ARMword addr, ARMword data)
{
	printf ("cs89712_io_write_byte error\n");
	skyeye_exit (-1);
}

void
cs89712_io_write_halfword (void * state, ARMword addr, ARMword data)
{
	printf ("cs89712_io_write_halfword error\n");
	skyeye_exit (-1);
}

void
cs89712_io_write_word (void * state, ARMword addr, ARMword data)
{
//	ARMword tmp;
