...
static ARMword
ns9750_io_read_word (void * state, ARMword addr)
{
...
static ARMword
ns9750_io_read_byte (void * state, ARMword addr)
{
	SKYEYE_DBG ("ns9750_io_read_byte error\n");
	return ns9750_io_read_word (state, addr);
}

static ARMword
ns9750_io_read_halfword (void * state, ARMword addr)
{
	SKYEYE_DBG ("ns9750_io_read_halfword error\n");
	return ns9750_io_read_word (state, addr);
}

static void
ns9750_io_write_word (void * state, ARMword addr, ARMword data)
{
	if ((addr >= AT91RM92_UART_BASE0) &&
	    (addr < AT91RM92_UART_BASE0 + AT91RM92_UART_SIZE)) {
...
static void
ns9750_io_write_byte (void * state, ARMword addr, ARMword data)
{
	SKYEYE_DBG ("ns9750_io_write_byte error\n");
	ns9750_io_write_word (state, addr, data);
}

static void
ns9750_io_write_halfword (void * state, ARMword addr, ARMword data)
{
	SKYEYE_DBG ("ns9750_io_write_halfword error\n");
	ns9750_io_write_word (state, addr, data);
}
