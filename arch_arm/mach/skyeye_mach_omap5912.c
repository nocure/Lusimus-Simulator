...
omap5912_update_int (void * state)
{
	...
	//printf("requests %x\n",requests);
	((ARMul_State*)state)->NirqSig = (requests) ? LOW : HIGH;
	((ARMul_State*)state)->NfiqSig = HIGH;
...
static void
omap5912_io_write_word (void * state, ARMword addr, ARMword data)
{
...
void
omap5912_io_write_byte (void * state, ARMword addr, ARMword data)
{
...
void
omap5912_io_write_halfword (void * state, ARMword addr, ARMword data)
{
...
ARMword
omap5912_io_read_word (void * state, ARMword addr)
{
	ARMword data = -1;
	...
	switch (addr) { 
		...
		case GPIO2_CLEAR_IRQENABLE2:
			...
			break;
		case GPIO2_CLEAR_WAKEUPENA:
			data = omap5912_io.gpio[1].gpio_clear_wakeupena;
			break;
		case GPIO2_CLEAR_DATAOUT:
...
ARMword
omap5912_io_read_byte (void * state, ARMword addr)
{
...
ARMword
omap5912_io_read_halfword (void * state, ARMword addr)
{
