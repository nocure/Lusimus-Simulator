...
static ARMword
s3c2440_io_read_word (void * state, ARMword addr)
{
...
static ARMword
s3c2440_io_read_byte (void * state, ARMword addr)
{
	return s3c2440_io_read_word (state, addr);
}

static ARMword
s3c2440_io_read_halfword (void * state, ARMword addr)
{
	return s3c2440_io_read_word (state, addr);
}

static void
s3c2440_io_write_word (void * state, ARMword addr, ARMword data)
{
	if ((addr >= UART_CTL_BASE0)
	    && (addr < UART_CTL_BASE0 + UART_CTL_SIZE)) {
...
static void
s3c2440_io_write_byte (void * state, ARMword addr, ARMword data)
{
	SKYEYE_DBG ("s3c2440_io_write_byte error\n");
	s3c2440_io_write_word (state, addr, data);
}

static void
s3c2440_io_write_halfword (void * state, ARMword addr, ARMword data)
{
	SKYEYE_DBG ("s3c2440_io_write_halfword error\n");
	s3c2440_io_write_word (state, addr, data);
}
