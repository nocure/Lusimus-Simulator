...
s3c4510b_io_do_cycle (void * state)
{
	...
	s3c4510b_update_int (state);
								 ...
								 * */
ARMword
s3c4510b_io_read_word (void * state, ARMword addr)
{
	ARMword data = -1;
	switch (addr) {
	case SYSCFG:
...
ARMword
s3c4510b_io_read_byte (void * state, ARMword addr)
{

	//printf("s3c4510b_io_read_byte error\n");
	return s3c4510b_io_read_word (state, addr);
}

ARMword
s3c4510b_io_read_halfword (void * state, ARMword addr)
{

	//printf("s3c4510b_io_read_halfword error\n");
	return s3c4510b_io_read_word (state, addr);
}
 ...
 * */
void
s3c4510b_io_write_word (void * state, ARMword addr, ARMword data)
{
	switch (addr) {
	case SYSCFG:
		io.syscfg = data;
...
void
s3c4510b_io_write_byte (void * state, ARMword addr, ARMword data)
{

	//printf("s3c4510b_io_write_byte error\n");
	s3c4510b_io_write_word (state, addr, data);
}

void
s3c4510b_io_write_halfword (void * state, ARMword addr, ARMword data)
{

	//printf("s3c4510b_io_write_halfword error\n");
	s3c4510b_io_write_word (state, addr, data);
}
