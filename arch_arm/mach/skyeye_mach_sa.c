...
sa_io_reset (void * state)
{
 ...
 /*TNF*/};
void
sa_io_write_byte (void * state, ARMword addr, ARMword data)
{
	printf ("sa_io_write_byte error\n");
	skyeye_exit (-1);
}

void
sa_io_write_halfword (void * state, ARMword addr, ARMword data)
{
	printf ("sa_io_write_halfword error\n");
	skyeye_exit (-1);
}

static void
sa_io_write_word (void * state, ARMword addr, ARMword data)
{
	switch (addr) {
	 /*RTC*/ case RCNR:
		sa_io.rcnr = data;
...
ARMword
sa_io_read_byte (void * state, ARMword addr)
{
	printf ("sa_io_read_byte error\n");
	skyeye_exit (-1);
}

ARMword
sa_io_read_halfword (void * state, ARMword addr)
{
	printf ("sa_io_read_halfword error\n");
	skyeye_exit (-1);
}

ARMword
sa_io_read_word (void * state, ARMword addr)
{
	u32 data;
