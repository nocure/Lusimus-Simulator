...
static void au1100_io_do_cycle(void * state) {
#if 1
...
static UInt32 au1100_io_read_byte(void * state, UInt32 addr) {
//	UInt32 ret;
...
static UInt32 au1100_io_read_halfword(void * state, UInt32 addr) {
//	UInt32 ret;
//	MIPS_State * mstate = (MIPS_State *)state;
	switch (addr) {
	default:
...
static UInt32 au1100_io_read_word(void * state, UInt32 addr) {
...
static void au1100_io_write_byte(void * state, UInt32 addr, UInt32 data) {
...
static void au1100_io_write_halfword(void * state, UInt32 addr, UInt32 data) {
//	MIPS_State * mstate = (MIPS_State *)state;
	switch (addr) {
	case 0x19800028:
...
static void au1100_io_write_word(void * state, UInt32 addr, UInt32 data) {
//	MIPS_State * curr_state = (MIPS_State*)state;
...
static void au1100_update_intr(void *mach) {
}
...
void au1100_mach_init(void * state, machine_config_t * this_mach) {
	MIPS_State * mstate = (MIPS_State*)state;
