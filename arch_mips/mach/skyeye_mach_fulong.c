...
static void fulong_io_do_cycle(void * state) {
...
static UInt32 fulong_io_read_byte(void * state, UInt32 addr) {
	UInt32 ret;
...
static UInt32 fulong_io_read_halfword(void * state, UInt32 addr) {
	UInt32 ret;
...
static UInt32 fulong_io_read_word(void * state, UInt32 addr) {
...
static void fulong_io_write_byte(void * state, UInt32 addr, UInt32 data) {
...
static void fulong_io_write_halfword(void * state, UInt32 addr, UInt32 data) {
...
static void fulong_io_write_word(void * state, UInt32 addr, UInt32 data) {
	MIPS_State * curr_state = (MIPS_State*)state;
...
#if 0
static void fulong_disable_int() {

}

static void fulong_enable_int() {

}

static void fulong_clear_int(UInt32 irq) {

}

static void fulong_sti(UInt32 dreg) {

}

static void fulong_cli(UInt32 dreg) {

}
#endif

static void fulong_set_int(UInt32 irq) {

}

void fulong_mach_init(void * state, machine_config_t * this_mach) {
