...
static void vr41xx_io_do_cycle(void * state) {
...
static UInt32 vr41xx_io_read_byte(void * state, UInt32 addr) {
	UInt32 ret;
...
static UInt32 vr41xx_io_read_halfword(void * state, UInt32 addr) {
//	UInt32 ret;
...
static UInt32 vr41xx_io_read_word(void * state, UInt32 addr) {
...
static void vr41xx_io_write_byte(void * state, UInt32 addr, UInt32 data) {
...
static void vr41xx_io_write_halfword(void * state, UInt32 addr, UInt32 data) {
	MIPS_State * mstate = (MIPS_State *)state;
...
static void vr41xx_io_write_word(void * state, UInt32 addr, UInt32 data) {
//	MIPS_State * curr_state = (MIPS_State*)state;
	/* uart write word */
	if (addr >= 0x10101000 && addr < 0x10103000) {
...
#if 0
static void vr41xx_disable_int() {

}

static void vr41xx_enable_int() {

}

static void vr41xx_clear_int(UInt32 irq) {

}

static void vr41xx_sti(UInt32 dreg) {

}

static void vr41xx_cli(UInt32 dreg) {

}
#endif

static void vr41xx_set_int(UInt32 irq) {

}

void vr41xx_mach_init(void * state, machine_config_t * this_mach) {
