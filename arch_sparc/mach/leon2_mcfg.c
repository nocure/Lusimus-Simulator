 ...
 * =====================================================================================
 */
static uint32 leon2_mcfg_write(void *opaque, uint32 addr, uint32 val) {
	// do nothing
	return 0;
}
...
//    bzero((void*)&leon2_mcfg, sizeof(leon2_mcfg));
	memset((void*)&leon2_mcfg, 0, sizeof(leon2_mcfg));

	leon2_mcfg.address = address;
	leon2_mcfg.regs[0] = 0x00000233;
	leon2_mcfg.regs[1] = 0x00001220;

	leon2_register_io_memory(address, MCFG_REGS * 4, leon2_mcfg_write, leon2_mcfg_read, NULL);
