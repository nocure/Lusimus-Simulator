...
#include "armdefs.h"
#include "../arch_mips/common/mipsdef.h"
...
void lcd_ep7312_init (struct device_module_set *mod_set);
void lcd_pxa_init (struct device_module_set *mod_set);
void lcd_s3c2410_init (struct device_module_set *mod_set);
