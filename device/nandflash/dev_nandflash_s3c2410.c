...
{
	// FIXME ww 2018-0816 apparently this calls read work (32-bit) and place 32-bit value in data (u8*)
	return nandflash_s3c2410_read_word(dev,addr,(u32*)data);
}
...
{
	return nandflash_s3c2410_write_word(dev,addr,(u32)data);
}
static int
