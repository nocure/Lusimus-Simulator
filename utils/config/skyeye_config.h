...
#define DEFAULT_CONFIG_FILE "sys.conf"
#define DEFAULT_GDB_PORT 10000
...
int do_rwio_option ();		// ww 2014-0113 added
int do_sefsio_option ();	// ww 2015-1029 added
int do_sound_option ();
...
// ww 2014-0113 moved static skyeye_option_t skyeye_options[] to skyeye_config.c to avoid multiple definitions in various .c files
