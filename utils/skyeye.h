...
#define SKYEYE_INFO(msg...)		fprintf(stdout, ##msg)
...
#endif
//chy 2006-04-24
extern __attribute__((noreturn)) void skyeye_exit(int ret);

#define err_msg(fmt, args...)	fprintf(stderr, "%s %d: %s %s " fmt, __FILE__, __LINE__, __FUNCTION__, strerror(errno), ## args)
